...
class RatingDonutView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null) : View(context, attributeSet) {
    ...
    private fun drawStaticPicture() {
        // Создаем bitmap и вызываем отрисовывку фона и значения рейтинга
    ...
    private fun drawRating(canvas: Canvas) {
        ...
        canvas.drawArc(oval, -90f, convertProgressToDegrees(currentSweepAngle), false, strokePaint)
